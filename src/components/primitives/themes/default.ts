...
export default {
  ...
  dropdown: {
    base:
            'absolute z-10 w-auto p-2 mt-2 text-gray-600 bg-white border border-gray-100 rounded-lg shadow-md min-w-max-content dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700',
    align: {
      left: 'left-0',
      right: 'right-0'
    }
  ...
  popover: {
    base:
            'flex flex-col w-60 bg-gray-50 border border-gray-500 rounded-lg shadow-lg',
    container:
            'h-48 overflow-auto w-full px-4 mb-4 bg-gray-100 cursor-pointer'
  },
  // Avatar
  avatar: {
    base: 'relative rounded-full inline-block bg-red-600',
    size: {
      large: 'w-10 h-10',
      medium: 'w-8 h-8',
      small: 'w-6 h-6'
  ...
  badge: {
    ...
    primary: 'text-indigo-700 bg-indigo-100 dark:text-white dark:bg-indigo-600'
  },
  // Backdrop
  backdrop: {
    base:
  ...
  textarea: {
    ...
    active:
            'focus:border-indigo-400 dark:border-gray-600 dark:focus:border-gray-600 dark:bg-gray-700 dark:focus:shadow-outline-gray focus:shadow-outline-indigo',
  ...
  select: {
    ...
    active:
            'focus:border-indigo-400 dark:border-gray-600 dark:bg-gray-700 focus:shadow-outline-indigo dark:focus:shadow-outline-gray dark:focus:border-gray-600',
  ...
  input: {
    ...
    active:
            'focus:border-indigo-400 dark:border-gray-600 focus:shadow-outline-indigo dark:focus:border-gray-600 dark:focus:shadow-outline-gray dark:bg-gray-700',
    disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
    valid:
            'border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:shadow-outline-green dark:focus:shadow-outline-green',
    invalid:
            'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:shadow-outline-red dark:focus:shadow-outline-red',
    radio:
            'text-indigo-600 form-radio focus:border-indigo-400 focus:outline-none focus:shadow-outline-indigo dark:focus:shadow-outline-gray',
    checkbox:
            'text-indigo-600 form-checkbox focus:border-indigo-400 focus:outline-none focus:shadow-outline-indigo dark:focus:shadow-outline-gray'
  },
  // HelperText
  helperText: {
    base: 'text-xs',
  ...
  button: {
    ...
    primary: {
      ...
      active: 'active:bg-indigo-600 hover:bg-indigo-700 focus:shadow-outline-indigo',
      disabled: 'opacity-50 cursor-not-allowed'
    },
    outline: {
